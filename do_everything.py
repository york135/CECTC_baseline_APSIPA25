...
def predict_one_song(predictor, inference_kwargs, wav_path, song_id, results_dict, midi_output_path=None, raw_output_path=None
        , return_pitch_logit=False, device='cpu'):
    test_dataset = SeqDataset(device=device)
...
def main(args):
    ...
    song_id = '1'
    results = {}
    predict_one_song(predictor, inference_kwargs, wav_path, song_id, results, midi_output_path=output_path, device=device)
