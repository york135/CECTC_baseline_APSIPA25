...
def main(args, training_args):
    ...
    if training_args["use_weakly_dataset"] == True:
        if (training_args["training_dataset_dir"] != training_args["training_weakly_dataset_dir"] or 
            training_args["training_gt_pkl_label"] != training_args["training_weakly_gt_pkl_label"] ):
            ...
            predictor.training_weakly_dataset = predictor.training_dataset
